...
function email($otp, $email, $nama)
{
    ...
    $ci->email->from($c->webmail, 'Recruitment Asuransi Astra');
...
function email_test($otp, $email, $nama)
{
    ...
    $mail->setFrom($c->webmail, 'Recruitment Asuransi Astra'); // user email
    $mail->addReplyTo($c->webmail, 'Recruitment Asuransi Astra'); //user email
...
function email_default($email, $nama, $password)
{
    $ci = get_instance();
    $c = $ci->db->query("SELECT * FROM ex_setting WHERE id_setting='1'")->row();
    ...
    // SMTP configuration
    $mail->Host     = "mail.clickicm.co.id";
    $mail->SMTPAuth = true;
    $mail->Username = "support@clickicm.co.id"; //user email
    $mail->Password = "UKXK~PrL-!AJ"; //password email
    $mail->SMTPSecure = 'tls';
    $mail->Port     = 587;
    $mail->SetFrom("support@clickicm.co.id", "Konfirmasi Pembayaran"); //set email pengirim
    $mail->addReplyTo('support@clickicm.co.id', 'Admin'); //user email anda

    // Email subject
    $mail->Subject = 'Informasi Akses Online Recruitment Test Asuransi Astra'; //subject email

    // Add a recipient
    $mail->addAddress($email, $nama); //email tujuan pengiriman email
    ...
    <head>
        <meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
        <title>Informasi Akses Online Recruitment Test Asuransi Astra</title>
        <meta name="description" content="Forget Passwrod.">
        <style type="text/css">
            a:hover {
                ...
                <td>
                    <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="text-align:center;">
                                <a href="https://www.asuransiastra.com/" title="logo" target="_blank">
                                    <img width="60" src="https://www.asuransiastra.com/wp-content/uploads/2016/04/asuransi_astra_logo-57-1.png" title="logo" alt="logo">
                                </a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;background:#fff; border-radius:3px; -webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h2 style="color:#1e1e2d; font-weight:500; margin:0;font-size:18px;font-family:" Rubik",sans-serif;">Dear ' . $nama . '</h2>
                                            <span style="display:inline-block; vertical-align:middle; margin:10px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0 0 10px 0;">
                                                Berikut kami informasikan link beserta username dan password untuk anda dapat mengerjakan Online Recruitment Test Asuransi Astra.
                                            </p>
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                Link Website : <a href="https://itrecruitment.asuransiastra.com">https://itrecruitment.asuransiastra.com</a>
                                            </p>
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                Username : ' . $email . '
                                            </p>
                                            ...
                                            <p style="color:#455056; font-size:15px;line-height:24px; ">
                                                Setelah login, mohon untuk segera merubah password dan melengkapi data diri dengan menekan tombol Update Info.
                                            </p>
                                            <p style="color:#455056; font-size:15px;line-height:24px;">
                                                Demikian informasi yang dapat kami sampaikan, jika terdapat pertanyaan lanjutan silahkan menghubungi PIC terkait.
                                            </p>
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                Terima kasih.
                                            </p>
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                Tim Rekrutmen Asuransi Astra
                                            </p>
                        ...
                        <tr>
                            <td style="text-align:center;">
                                <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>https://www.asuransiastra.com//</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td style="height:80px;">&nbsp;</td>
