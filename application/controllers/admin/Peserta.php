...
class Peserta extends CI_Controller
{
    ...
    public function save()
    {
        ...
        $sandi                   = generate_password();
        $password                = md5(md5($sandi));
        ...
        $this->session->set_flashdata('user_input', $inputan);
                ...
                if ($_FILES["file"]["name"] != '') {
                    if (!$this->upload->do_upload('file')) {
                        ...
                        if (!preg_match("/^[a-zA-Z ]*$/", $this->input->post('nama'))) {
                            ...
                            email_default($this->input->post('email'), $this->input->post('nama'), $sandi);
                            redirect('../admin/peserta/');
                        }
                    }
                } else {
