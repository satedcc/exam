                            ...
                            <div class="col">
                                ...
                                foreach ($soal as $s) : $no = $x++; ?>
                                    <div class="soal" id="soal-<?= $no; ?>" data-value="<?= $s->id_soal ?>">
                                        ...
                                        <button type="button" class="btn btn-danger prev" value="<?= $no ?>"><i class="fal fa-angle-double-left"></i> BACK QUESTION</button>
                                        <button type="button" class="btn btn-dark next" value="<?= $no + 1; ?>" id="<?= $s->id_soal ?>">NEXT QUESTION <i class="fal fa-angle-double-right"></i></button>
                                ...
                                <div class="finish-soal">
                                    <div class="card" style="margin-bottom: 10px;">
                                        <div class="card-body text-center">
                                            ...
                                            <p class="m-0">Please double-check all the answers and make sure all the questions have been answered!</p>
                                            <p class="m-0">If you are ready to submit your answers and complete the exam, click the SUBMIT button!’</p>
                                            <button class="btn btn-main btn-proses">Submit Answer</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="alert alert-warning" style="margin-top: 30px;">
                                    Please pay attention to the questions before clicking <strong>NEXT</strong>, you can change the answer back by clicking on the question navigation
                                </div>
                </form>
            </div>
            <div class="col-sm">
                    ...
                    <div class="card-body navigasi">
                        ...
                        <ul class="navsoal">
                            ...
                            foreach ($soal as $s) :
                                ...
                                <?php if ($x > 0) : ?>
                                    <li id="nav-<?= $no ?>" class="actives"><a href="#soal-<?= $no ?>"><?= $no; ?></a></li>
                                <?php else : ?>
                                    <li id="nav-<?= $no ?>"><a href="#soal-<?= $no ?>"><?= $no; ?></a></li>
                                <?php endif; ?>
                            <?php $no++;
                            endforeach; ?>
                        </ul>
...
<div class="disabled-menu-notif">
    <p class="m-0">Mohon maaf selama exam berlangsung menu akan terdisabled</p>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        <?php if (empty($last)) : ?>
            $(".soal:first").show()
            $(".soal:first button.prev").hide()
            // $(".soal:first .prev").hide()
        <?php else : ?>
            $(".soal:eq(<?= $last - 1 ?>)").show()
        <?php endif; ?>
...
<script>
    Swal.fire({
        ...
        if (result.value) {
            $(".cssmenu ul li a").addClass("disabled-menu")
            $(".blur-bg").hide()
            ...
            $("body").on("click", ".disabled-menu", function(e) {
                e.preventDefault();
                $(".disabled-menu-notif").slideDown();
                setTimeout(() => {
                    $(".disabled-menu-notif").slideToggle();
                }, 5000);
            });
            ...
            <?php if ($info->jenis_waktu == "T") : ?>
                ...
                $("body").on("click", ".prev", function(e) {
                    e.preventDefault();
                    var contTarget = "#soal-" + parseInt($(this).val() - 1);
                    //Hide all content
                    $('.col > div.soal').hide();
                    //Show the target
                    $(contTarget).show();
