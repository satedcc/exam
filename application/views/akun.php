						...
						<form action="<?= base_url('akun/save') ?>" method="post" enctype="multipart/form-data">
							<div class="card">
								<div class="card-body">
									...
									<div class="hr">
										<div style="margin: 5px 0;display: flex;justify-content:end;">
											<label class="checkbox" for="change-password">
												<input type="checkbox" name="color" value="change-password" id="change-password">
										...
										<div class="form-group">
											...
											<input disabled type="password" name="old" id="old" placeholder="current password" value="">
										</div>
										<div class="form-group">
											<label for="confirm">New Password</label>
											<input disabled type="password" name="new" id="new" placeholder="new password" value="">
										</div>
										<div class="form-group">
											<label for="confirm">Confirm Password</label>
											<input disabled type="password" name="confirm" id="confirm" placeholder="confirm password" value="">
											<span class="badge">Please leave it blank if you don't want the password to be changed</span>
										</div>
									</div>
									<div class="form-group">
