        ...
        <div class="col-md-9 mx-auto">
            <div class="card card-hover card-task-one">
                ...
                <div class="card-body-item">
                    ...
                    <div class="form-group row border-dashed">
                        <label for="susah" class="col-sm-3 col-form-label font-weight-bold">Question Random </label>
                        <div class="col-sm-9">
                            <input type="text" disabled class="form-control" id="score" name="score" placeholder="minimum score" value="<?php if (isset($row)) echo $row->random ?>">
                        </div>
                    </div>
                    <div class="form-group row border-dashed">
