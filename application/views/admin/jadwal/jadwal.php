                    ...
                    <div class="table-responsive">
                        <table class="table stripe hover" id="example1">
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                foreach ($jadwal as $j) {
                                    $random = ($j->random == "Y") ? '<span class="badge badge-primary">Random</span>' : '<span class="badge badge-warning">No</span>';
                                    echo '<tr>
                                            <td>' . $no++ . '</td>
                                            <td><a href="#modal2" data-value="' . $j->id_jadwal . '" data-toggle="modal" class="all-partisipant">' . $j->kode_jadwal . '</a></td>
                                            <td><a href="' . base_url('admin/jadwal/listpartisipan/' . $j->id_jadwal) . '">' . $j->nama_jadwal . '</a></td>
                                            ...
                                            <td>' . $random . '</td>
                                            <td>
                                                <a href="' . base_url('admin/jadwal/analytics/' . $j->id_jadwal) . '" class="badge badge-success rounded-5"><i class="fas fa-analytics"></i></a>
