...
$fields = $this->session->flashdata('user_input');
?>
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/peserta/save/') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" required class="form-control" id="nama" name="nama" placeholder="full name" value="<?php if (isset($row)) echo $row->nama_lengkap ?><?php if (isset($fields)) echo $fields['nama'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label font-weight-bold">NIK</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="nik" name="nik" placeholder="nik" value="<?php if (isset($row)) echo $row->nik ?><?php if (isset($fields)) echo $fields['nik'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" required class="form-control" id="tempat" name="tempat" placeholder="place of birth" value="<?php if (isset($row)) echo $row->tempat_lhr ?><?php if (isset($fields)) echo $fields['tempat'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label font-weight-bold">Birth</label>
                            <div class="col-sm-10">
                                <input type="text" required class="form-control" id="tanggal" name="tanggal" placeholder="date" value="<?php if (isset($row)) echo $row->tgl_lahir ?><?php if (isset($fields)) echo $fields['tanggal'] ?>" min="1950-01-01">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label font-weight-bold">Email</label>
                            <div class="col-sm-10">
                                <input type="email" required class="form-control" id="email" name="email" placeholder="email address" value="<?php if (isset($row)) echo $row->email_peserta ?><?php if (isset($fields)) echo $fields['email'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" required class="form-control" id="nomor" name="nomor" placeholder="phone number ex 0811234500" value="<?php if (isset($row)) echo $row->nomor_peserta ?><?php if (isset($fields)) echo $fields['nomor'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" required class="form-control" id="alamat" name="alamat" placeholder="address" value="<?php if (isset($row)) echo $row->alamat_peserta ?><?php if (isset($fields)) echo $fields['nik'] ?>">
                            </div>
                        </div>
                        <!-- <div class="form-group row">
