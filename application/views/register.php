    ...
    <div class="form-login">
        ...
        <form action="<?= base_url('register/save/') ?>" method="post">
            <div class="form-group">
                <label for="nik">NIK <span style="color:#aaa;">(optional)</span></label>
                <input type="number" autofocus autocomplete="off" name="nik" id="nik" placeholder="NIK" value="<?= set_value('nik') ?>">
            </div>
            <div class="form-group">
